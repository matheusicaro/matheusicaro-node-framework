...
/**
 * This types were previous imported from vitest.
 *
 * However vitest needs to use Vite which has issue on using rollup dependency.
 * Issue: https://github.com/vitest-dev/vitest/issues/4567
 *
 * The solution here is removed vitest as a dependency and copy/paste the types which is the only thing
 * needs on the vitest stub here.
 *
 * @matheusicaro
 *
 */
